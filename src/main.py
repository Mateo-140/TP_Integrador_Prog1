import os
from src.datos import cargar_csv, guardar_csv, mostrar_paises
from src.validaciones import agregar_pais, actualizar_pais
from src.busqueda import buscar_pais
from src.filtros import filtrar_continente, filtrar_poblacion, filtrar_superficie
from src.ordenamiento import ordenar_nombre, ordenar_poblacion, ordenar_superficie
from src.estadisticas import mostrar_estadisticas

def menu():
    # Muestra el menú principal del sistema y gestiona la navegación.
    # Carga el archivo CSV al inicio, ejecuta la opción seleccionada y guarda los cambios.
